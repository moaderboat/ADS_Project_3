...
## B:
Copy code
# g++ -std=c++17 -O2 -Wall -Wextra main.cpp insertion_sort.cpp selection_sort.cpp shell_sort.cpp heap_sort.cpp merge_sort.cpp quick_sort.cpp radix_sort.cpp -o sorting.exe
